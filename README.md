...
to:
```
direnv: export +DEVSHELL_DIR +PRJ_DATA_HOME +PRJ_ROOT +IN_NIX_SHELL +NIXPKGS_PATH ~PATH
```
...
* `PRJ_DATA_HOME`: points to `$PRJ_ROOT/.data` by default. Is used to store runtime data.
